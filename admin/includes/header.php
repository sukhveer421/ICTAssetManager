				...
				<div class="navbar-buttons navbar-header pull-right" role="navigation">
                    ...
                    <li>
                      <a href="view-requisitions">
                        <div class="clearfix">
                          <span class="pull-left">
                            <i class="btn btn-xs no-hover btn-info fa fa-cloud-upload"></i>
                            Requisitions
                          </span>
                          <?php
                            if( $user->countExpiredWarranties()>0){
				...
				<ul class="nav nav-list">
					...
					<li class="<?php if(isset($activeParent)){echo $activeParent;} ?>">
						...
						<ul class="submenu">
							...
							<li class="<?php if(isset($activeAddAsset)){echo $activeAddAsset;} ?>">
								...
								<ul class="submenu">
									...
									<li class="<?php if(isset($activeOtherItems)){echo $activeOtherItems;} ?>">
										<a href="#" class="dropdown-toggle">
											Other Assets
											<b class="arrow fa fa-angle-down"></b>
										</a>
										...
										<ul class="submenu">
											<li class="<?php if(isset($activeAssignedItems)){echo $activeAssignedItems;} ?>">
											...
											<li class="<?php if(isset($activeLoanedItems)){echo $activeLoanedItems;} ?>">
												<a href="view-leases">
													Loaned Assets
												</a>
                      ...
                      <li class="<?php if(isset($reqitems)){echo $reqitems;} ?>">
											...
											<li class="<?php if(isset($activeUntrceableItems)){echo $activeUntrceableItems;} ?>">
