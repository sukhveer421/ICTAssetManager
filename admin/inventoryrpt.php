...
$pdf->Image('../assets/images/county/county.png',125,5,40);
...
//********************INVENTORY TITLE*************************************
 ...
 $pdf->Cell(0,85,"WEST POKOT COUNTY ICT DEPARTMENT",0,0, "C");
 //******************END TITLE************************************************
...
//******************TABLE BODY******************************************************
//fetch db values
 $stmt = $db->prepare('SELECT DISTINCT AssetSerial, Id, AssetNumber, Status, AssetCondition, Custodian, Office, Department FROM new_inventory WHERE DateAdded = :DateAdded');
