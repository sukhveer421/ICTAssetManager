														...
														<form class="form-horizontal" id="validation-form" method="get">
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" id="TechnicianNumber" name="TechnicianNumber" class="col-xs-12 col-sm-5" value="WPC/ICT/TECHNICIAN/<?php echo $user->getLastRecord('new_technicianr'); ?>" disabled />
																	</div>
																</div>
															</div>
