																	...
																	<div class="tab-content">
																		...
																		<div id="custodian" class="tab-pane fade">
																			<div class="form-group">
																				...
																				<div class="col-xs-12 col-sm-9">
																					<div class="clearfix">
																						<input type="text" name="ScrapValue" id="ScrapValue" class="col-xs-12 col-sm-6" value="<?php
																						 if($row['SerialNumber']=="N/A")
																						 {
																							 $custodian = $user->getCustodian($row['AssetNumber']);
																							 echo $user->getUserName($custodian);
																						 }else{
																							 $custodian = $user->getCustodian($row['SerialNumber']);
																							 echo $user->getUserName($custodian);
																						 }  ?>" />
																					</div>
																				</div>
