				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">Request an asset</li>
						</ul><!-- /.breadcrumb -->
														...
														<form class="form-horizontal" id="general-information" method="get">
															...
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" name="user" id="user" class="col-xs-12 col-sm-4" disabled="true" value="<?php echo $row_user_info['Name'];?>"/>
																	</div>
																</div>
															</div>
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" name="userOffice" id="userOffice" class="col-xs-12 col-sm-4" disabled="true" value="<?php echo $row_user_info['Office'];?>"/>
																	</div>
																</div>
															</div>
															...
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" name="userDepartment" id="userDepartment" class="col-xs-12 col-sm-4" disabled="true" value="<?php echo $row_user_info['Department'];?>" />
																	</div>
																</div>
															</div>
